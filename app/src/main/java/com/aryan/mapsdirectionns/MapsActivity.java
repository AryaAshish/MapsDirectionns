package com.aryan.mapsdirectionns;
        ...
        GoogleMap.OnMarkerDragListener
{
    ...
    public void onClick(View v)
    {
        ...
        switch(v.getId()) {
            ...
            case R.id.B_restaurant:
                ...
                getNearbyPlacesData.execute(dataTransfer);
                Toast.makeText(MapsActivity.this, "Showing Nearby Restraunts", Toast.LENGTH_LONG).show();
                break;
            case R.id.B_school:
                mMap.clear();
    ...
    private String getUrl(double latitude, double longitude, String nearbyPlace)
    {
        ...
        googlePlacesUrl.append("&key=" + "AIzaSyA2ZFoIFB_yNKMwA_t1HODnT4Qtl6T3NiM");
